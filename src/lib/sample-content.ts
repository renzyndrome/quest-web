...
export const sampleAnnouncements: Announcement[] = [
  {
    ...
    date: '2026-07-05',
    category: 'Campaign',
    body: 'Our new season starts with a combined worship service at Laguna Main. All locations are invited.',
    pinned: true,
    banner: null,
  },
  {
    ...
    date: '2026-06-27',
    category: 'Update',
    body: 'Starting this Friday, Young Pro gathers at the NXTGN Hall. Same time, 7:00 PM.',
    pinned: false,
    banner: null,
  },
  {
    ...
    body: 'Saturday 5:00 AM prayer and worship is back. Come as you are.',
    pinned: false,
    banner: null,
  },
];
